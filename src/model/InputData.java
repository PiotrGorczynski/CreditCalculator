...
{
    private LocalDate repaymentStartDay = LocalDate.of(2020,1,6);
    ...
    //first we pay off the rate, then we overpay
    ...
    public InputData withbankMarginPercent(BigDecimal barkMarginPercent){
        this.bankMarginPercent = barkMarginPercent;
        return this;
    }
